...
export type Milestone = {
  ...
  photo?: boolean;
  /** Age 20 shows a "klik mij niet" peeker (easter egg) that unlocks the secret page. */
  peek?: boolean;
...
export const milestones: Milestone[] = [
  ...
  { age: "19", title: "Griekenland roept", text: "Op naar Corfu voor een stage bij Ikos Dassia. Het avontuur van het jaar.", photo: true, trip: true },
  { age: "20", title: "Twintig", text: "En hier zijn we. Gefeliciteerd Ryan — deze is voor jou.", photo: true, big: true, peek: true },
];
